...
#
# Also sets XSD_FOUND XSD_INCLUDE_DIRS
...
#  GET_FILENAME_COMPONENT( xs_OUT_DIR "${xs_OUT_TMP}" PATH)
  SET( xs_OUT_DIR "${CMAKE_BINARY_DIR}/src" )
  SET( xs_CXX "${xs_OUT_DIR}/${xs_FILE}.cxx" )
  SET( xs_HXX "${xs_OUT_DIR}/${xs_FILE}.hxx" )
  #SET( xs_IXX "${xs_FILE_DIR}/${xs_FILE}.ixx" )

  #
  # Add the source files to the NAME variable, which presumably will be used to
  # define the source of another target.
  #
  LIST( APPEND ${NAME} ${xs_CXX} ${xs_HXX} )
