...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Required attributes (or child elements with single cardinality)
        // can just be accessed directly.
        std::cout << "Parsed model id " << model->id() << std::endl;

        // Optional content has an _optional type wrapping it, with present()
        // and get() methods.
        ...
        if (metaid.present())
        {
	        ...
	        // We often don't bother assigning to a variable, because
	        // the type names get long.
